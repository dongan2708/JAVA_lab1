package JAVA2_11eBookStore3.Models;
...
public class Book {
    ...
    public Book(int bookID, String title, String author, int years, int status, int genre, int qty, double price,String createddate,String updateddate){
        this.bookID=bookID;
        this.title=title;
        this.author=author;
        this.years=years;
